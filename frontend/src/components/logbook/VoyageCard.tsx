  ...
  return (
    <li>
      <button
        type="button"
        onClick={onClick}
        className="group flex w-full items-stretch gap-4 rounded-2xl bg-white p-4 text-left ring-1 ring-navy-100 shadow-sm transition-all duration-200 ease-sail hover:-translate-y-px hover:ring-ocean-300 hover:shadow-chart"
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          {entry.description && (
            <p className="mt-1.5 truncate text-sm text-navy-500">{excerptOf(entry.description)}</p>
          )}
        </div>
      </button>
    </li>
